    ...
    <div style={{ minHeight: '100vh', background: '#020617' }}>
      ...
      <Suspense fallback={
        ...
        <Routes>
          ...
          <Route path="/received-payments" element={<PrivateRoute><ReceivedPaymentPage /></PrivateRoute>} />
          <Route path="/customer-dues" element={<PrivateRoute><CustomerDuesPage /></PrivateRoute>} />
