...
import { Printer, Search, RefreshCw, Save, User, FileText } from 'lucide-react';
import { api, MD_CONFIG } from '../utils/apiConfig';
import { formatDate, toISODate, formatINR, numberToWords, parseUTCDate } from '../utils/smartUtils';
...
export default function TaxInvoicePage() {
  ...
  const reset = () => setInvoice(blankInvoice());
  ...
  // ────────── STYLES ──────────
  const S = {
    wrap: { padding: 12, background: '#020617', minHeight: '100vh', color: 'white' },
        ...
        <div style={S.wrap}>
          ...
          <div style={S.toolbar}>
            <button style={S.btn} onClick={() => setShowSearch(true)}>
              <Search size={16} /> Customer Select करें
            </button>
            <button style={S.btnGhost} onClick={reset}>
              <RefreshCw size={16} /> Reset
            </button>
            <button style={{ ...S.btn, background: '#2563eb', marginLeft: 'auto' }} onClick={handlePrint}>
